...
public class ProfiloAcquirenteDaAstaDAO {

    private Connection connection;
    private ProfiloAcquirente profiloAcquirente;
    private String mail;
    private String tipoUtente;

    public ProfiloAcquirenteDaAstaDAO(ProfiloAcquirente profiloA, String email, String tipoUtente) {
        this.profiloAcquirente = profiloA;
        this.mail = email;
        this.tipoUtente = tipoUtente;
    }

    public void openConnection() {
        new ProfiloAcquirenteDaAstaDAO.DatabaseTask().execute("open");
    }
    ...
    public void findUser() {
        ...
        new ProfiloAcquirenteDaAstaDAO.DatabaseTask().execute("find");
    }
    ...
    public void getSocialNamesForEmail() {
        ...
        new ProfiloAcquirenteDaAstaDAO.DatabaseTask().execute("get_social_names");
    }


    public void closeConnection() {
        new ProfiloAcquirenteDaAstaDAO.DatabaseTask().execute("close");
    }
    ...
    private class DatabaseTask extends AsyncTask<String, Void, Object> {
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result instanceof Acquirente) {
                ...
                profiloAcquirente.updateSocialNames(socialNames, socialLinks);
            } else {
