...
public class VenditoreFragmentSelezioneCategorie extends Fragment {
    ...
    public VenditoreFragmentSelezioneCategorie() {
        // Costruttore vuoto richiesto dal framework
    }

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.venditore_fragment_selezione_categorie, container, false);
