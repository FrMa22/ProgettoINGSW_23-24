...
public class Asta_inversa_DTO {
    ...
    public Asta_inversa_DTO(String nome, String descrizione, String path_immagine, float prezzoMax, float prezzoAttuale, String dataDiScadenza, String condizione, String id_acquirente) {
        this.nome = nome;
        this.descrizione = descrizione;
        this.path_immagine = path_immagine;
        this.prezzoMax = prezzoMax;
